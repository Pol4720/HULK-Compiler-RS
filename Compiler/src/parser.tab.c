...
static const char *const yytname[] =
{
  ...
  "PLUS", "MINUS", "PRODUCT", "DIV", "'('", "')'", "$accept", "input",
...
{
       1,     9,    10,     9,    10,     8,     2,     0,    13,    11,
      12,     7,    14,    15,     0,    16,    17
};

static const yytype_int8 yycheck[] =
{
       3,     5,     6,     5,     6,     0,     9,    -1,    10,     7,
       8,     2,     9,    10,    -1,    11,    12
};
...
#line 1079 "parser.tab.c"
  ...
  case 3: /* EXP: EXP PLUS TERM  */
#line 32 "parser.y"
                     { (yyval.dval) = (yyvsp[-2].dval) + (yyvsp[0].dval); }
#line 1085 "parser.tab.c"
    break;

  case 4: /* EXP: EXP MINUS TERM  */
#line 33 "parser.y"
                      { (yyval.dval) = (yyvsp[-2].dval) - (yyvsp[0].dval); }
...
#line 1097 "parser.tab.c"
  ...
  case 6: /* TERM: TERM PRODUCT FACTOR  */
#line 37 "parser.y"
                            { (yyval.dval) = (yyvsp[-2].dval) * (yyvsp[0].dval); }
