...
impl TypeAST {
    ...
    pub fn new() -> Self {
        ...
        tree.add_type("String".to_string(), vec![], None, HashMap::new(), HashMap::new());
        tree.add_type("Number".to_string(), vec![], None, HashMap::new(), HashMap::new());
        tree.add_type("Boolean".to_string(), vec![], None, HashMap::new(), HashMap::new());
        tree.add_type("Unknown".to_string(), vec![], None, HashMap::new(), HashMap::new());
        tree
    }
